...
export class MainuiComponent implements OnInit {
 ...
 city:string;
  ...
  ngOnInit() {
   ...
   this.pineaple.mouth = "../mouthopen.png";
    // let eyes = document.getElementById("eyes");
  
  mouth.style.top = "240px";
   mouth.style.left="5%";
    //eyes.style.marginTop = "20px";
    setTimeout(()=>{this.pineaple.eyes = "../eyesnormal.png";
//this.pineaple.mouth = "../assets/imgs/mouth_closed.png";
  // mouth.style.top = "75px";
   ...
   this.pineaple.eyes = "../eyesnormal.png";
  this.pineaple.mouth = "../mouthclosed.png";
  mouth.style.top = "75px";
   this.pineaple.eyebrows = "../eyebrowsnormal.png";
   let blinktime = 0;
    var  normal;
...
//    this.pineaple.eyes = "../assets/imgs/eyes_closed.png";
 ...
 class PineapleController{
  ...
  mouth_closed:string;
constructor(){
  this.eyes_normal = "../eyesnormal.png";
  this.eyes_blinking = "../eyesblinking.png";
  this.eyes_talking =  "../eyestalking.png";
  this.mouth_open = "../mouthopen.png";
  this.mouth_closed = "../mouthclosed.png";
}
public change(mood){
